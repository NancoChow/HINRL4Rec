...
from models.MultSemMP_KG2Vec import MultSemMP_KG2Vec
from utils.common_utils import *
from utils.data_utils import AmazonDataLoader
...
def train(args):
    ...
    model = MultSemMP_KG2Vec(dataset, args).to(args.device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        torch.save(model.state_dict(), '{}/MultSemMP_KG2Vec_sd_epoch_{}.ckpt'.format(args.log_dir, epoch))


def extract_embeddings(args):
    """Note that last entity embedding is of size [vocab_size+1, d]."""
    model_file = '{}/MultSemMP_KG2Vec_sd_epoch_{}.ckpt'.format(args.log_dir, args.epochs)
...
def main():
    ...
    parser.add_argument('--name', type=str, default='MultSemMP_KG2Vec', help='model name.')
